# pp_cmd_monark_processing
Postprocessing command "monark_processing"
...
### Test monark_processing
Use `pp` to test monark_processing command:  
```bash
pp
Storage directory is /tmp/pp_cmd_test/storage
Commmands directory is /tmp/pp_cmd_test/pp_cmd
query: | otl_v1 <read_data> |  monark_processing 
```
